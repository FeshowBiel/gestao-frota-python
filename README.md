# 🚛 Sistema Corporativo de Gestão de Frota e Inteligência de Negócios
...
* **🗄️ Banco de Dados Relacional:** Estrutura em SQLite com proteção de integridade referencial.
...
* **Back-end / Dados:** Python, SQLite, DB-API
